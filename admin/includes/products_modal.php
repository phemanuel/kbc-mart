        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="products_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label for="category" class="col-sm-1 control-label">Sub-Category</label>
                ...
                $conn = $pdo->open();
                try{
                  $stmt = $conn->prepare("SELECT * FROM subcategory order by sub_cat_name ASC");
                  $stmt->execute();

                  foreach($stmt as $row){
                    echo "
                     
                      <option> ".$row['sub_cat_name']."</option>
