...
?>
<?php
     $slug = $_SESSION['sub_cat_slug'];
    $_SESSION['sub_cat_slug'] = $slug;
    $cat_slug= $_SESSION['cat_slug'];

    $sql="SELECT * FROM subcategory WHERE sub_cat_slug='".$slug."'";
    ...
    {
    $cat_id= $rowval['id'];
    $sub_cat_slug = $rowval['sub_cat_slug'];
    }
...
<head>
        ...
        <title>KBC Supermart || <?php echo $sub_cat_slug; ?> </title>
                ...
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            ...
                            <li class="active"><?php echo $sub_cat_slug ; ?></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="content-wraper pt-60 pb-60 pt-sm-30">
                <div class="container">
                    <div class="row">
                                ...
                                <div class="shop-bar-inner">
                                    <div class="product-view-mode">
                                        ...
                                        <ul class="nav shop-item-filter-list" role="tablist">                                           
                                            ...
                                            <li class="active" role="presentation"><a class="active show" data-toggle="tab" role="tab" aria-controls="list-view" href="#list-view"><i class="fa fa-th-list"></i></a></li>
                                        </ul>
                        ...
                        <span class="message"></span>
                            ...
                            <div class="shop-products-wrapper">
                                <div class="tab-content">
                                    ...
                                    <div id="list-view" class="tab-pane fade active show product-list-view" role="tabpanel">
                                        <div class="row">
                                            <div class="col">    
                        ...
                        // try{
                            //$inc = 4;  
                            $sql = "SELECT id,category_id,category_name,name,description,slug,price,photo,date_view FROM products WHERE sub_category_name='".$sub_cat_slug."' "; 
                            $result = $conn->query($sql);

                            $sql1="SELECT * FROM products WHERE sub_category_name='$sub_cat_slug' LIMIT $initial_page, $limit";
                                                            ...
                                                            <div class='product_desc_info'>
                                                                <div class='product-review'>
                                                                    <h5 class='manufacturer'>
                                                                        <strong><a href=''>Sub-Category: ".$sub_cat_slug."</a></strong>
                                                                    </h5>
                                                                    
                                                                </div>
                                                                <h4><a class='product_name' href='product?product=".$row['slug']."'>".$row['name']."</a></h4>
                                                                <div class='price-box'>
                                                                    <span class='new-price'><b>=N= ".number_format($row['price'], 2)."</b></span>
                                                                </div>
...
$getQuery = "SELECT COUNT(*) FROM products WHERE sub_category_name='".$sub_cat_slug."'";     
...
if($page_number>=2){   
    ...
    echo "<li class='Previous'><a href='sub_categorypage?page=".($page_number-1)."'>  <strong>Prev</strong> </a></li>";   
...
for ($i=1; $i<=$total_pages; $i++) {   
  ...
  if ($i == $page_number) {   
      ...
      $pageURL .= "<li><a class = 'active' href='sub_categorypage?page="  
      ...
      $pageURL .= "<li><a href='sub_categorypage?page=".$i."'>   
...
if($page_number<$total_pages){   
    ...
    echo "<li class='Next'><a href='sub_categorypage?page=".($page_number+1)."'>  <strong>Next</strong> </a></i></li>";   
...
?>                                            
                                ...
                                <div class="filter-sub-area pt-sm-10 pt-xs-10">
                                    <h5 class="filter-sub-titel">SUB-CATEGORY <?php echo " -> " .$cat_slug;  ?></h5>
                                    <div class="categori-checkbox">
                                        <form action="#">
                                                 <ul>
                                            <?php
    $sql = "SELECT id, cat_name, sub_cat_name,sub_cat_slug FROM subcategory where cat_name='$cat_slug' ";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo "
                <li><input type='checkbox' name='product-categori'><a href='sub_category?sub_cat=".$row['sub_cat_name']."''>".$row['sub_cat_name']."</a></li>
