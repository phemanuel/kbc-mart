...
<head>
        ...
        <title>KBC Supermart || Profile</title>
...
?><?php echo $count;  ?></span>
  ...
  <tr>
    <td width="160" rowspan="5" valign="top"><img src="<?php echo (!empty($user['photo'])) ? 'images/'.$user['photo'] : 'images/profile.jpg'; ?>" width="100" height="100" /></td>
    <td width="246"><span class="style7">Name:</span></td>
    <td width="394"><?php echo $user['firstname'].' '.$user['lastname']; ?>&nbsp;</td>
<td width="203"><span class="pull-right">
  ...
  <tr>
    <td><span class="style7">Contact Info:</span></td>
  ...
  <tr>
    <td><span class="style7">Member Since:</span></td>
