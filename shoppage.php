                                           ...
                                           echo " <div class='row product-layout-list'>
                                                    ...
                                                    <div class='col-lg-4'>
                                                        <div class='shop-add-action mb-xs-30'>
                                                            <ul class='add-actions-link'>
                                                                <li class='add-cart'><a href='product?product=".$row['slug']."'>Quick view</a></li>
                                                                <li class='wishlist'><a href='wishlist?product=".$row['slug']."'><i class='fa fa-heart-o'></i>Add to wishlist</a></li>
