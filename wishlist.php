...
$sql = "SELECT id,user_id,product_id,product_name,product_price,product_category,product_name,product_photo,slug FROM wishlist WHERE user_id='$user_id' ";
$result = $conn1->query($sql);
//==============
$sql1="SELECT * FROM wishlist WHERE user_id='$user_id' ";
$result1=mysqli_query($conn1,$sql1);
$count=mysqli_num_rows($result1);
//====================
if ($result->num_rows > 0) {

echo "<table border = '1' width = '100%'><thead><tr><th>S/N</th><th>Remove</th><th>Image</th><th>Item Name</th><th>Unit Price</th><th>Add to Cart</th></tr></thead>";
     ...
     //$c++ ;
         ...
         echo "<tr><td>" . ++$counter. "</td><td class='li-product-add-cart'>"."<a href='removeitem?id=". $row["id"]."'>"."Remove Item"."</a></td><td class='li-product-thumbnail'>" . "<img width='50' height='50' src='images/".$row["product_photo"]."' alt=''>". "</td><td class='cart-product-name'>" . $row["product_name"]."</td><td class='li-product-price'>" . "=N=" . number_format($row["product_price"],2). "</td><td class='li-product-add-cart'>"."<a href='product?product=". $row["slug"]."'>"."Add to Cart"."</a></td></tr>";
