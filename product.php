...
<?php
    ...
    try{
        ...
        $stmt = $conn->prepare("SELECT *, products.name AS prodname, category.name AS catname,category.id AS catid, products.id AS prodid FROM products LEFT JOIN category ON category.id=products.category_id WHERE slug = :slug");
...
<head>
        ...
        <title>KBC Supermart || <?php echo $product['catname']; ?></title>
                ...
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            ...
                            <li class="active"><?php echo $product['catname']; ?></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="content-wraper">
                <div class="container">                   
                    <div class="row single-product-area">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="product-details-view-content pt-60">
                                <div class="product-info">
                                    ...
                                    <span class="product-details-ref"><p><b>Category:</b> <a href="category?category=<?php echo $product['cat_slug']; ?>"><?php echo $product['catname'];
                                    $product_cat = $product['catname'];
                                    ?></a></p></span>
                                    
                                    <div class="price-box pt-20">
                                        <span class="new-price new-price-2"><b>=N= <?php echo number_format($product['price'], 2);?></b></span>
                                    </div>
                                    ...
                                    <div class="single-add-to-cart">
                                        <form action="#" class="cart-quantity" id="productForm">
                                            <div class="quantity">
                                                <label>Quantity</label>
                                                <div class="cart-plus-minus">
                                                    <input class="cart-plus-minus-box" value="1" name="quantity" id="quantity" type="text">
                                                    <div class="dec qtybutton" id="minus" ><i class="fa fa-angle-down"></i></div>
                                                    <div class="inc qtybutton" id="add"><i class="fa fa-angle-up"></i></div>
                                                </div>
                                            </div>
                                            <input type="hidden" value="<?php echo $product['prodid']; ?>" name="id">
                                            <input type="hidden" value="<?php echo $product['prodname']; ?>" name="product_name">
                                            <input type="hidden" value="<?php echo $product['catname']; ?>" name="product_category">
                                            <input type="hidden" value="<?php echo $product['price']; ?>" name="product_price">
                                            <button class="add-to-cart" type="submit">Add to cart</button>
                                        </form>
                                    </div>
                                    <div class="product-additional-info pt-25">
                                        <a class="wishlist-btn" href="wishlistadd?id=<?php echo $product['prodid']; ?>"><i class="fa fa-heart-o"></i>Add to wishlist</a>
                       ...
                       <h5><strong><span class="message" class="style4"></span></strong> </h5>
                    </div>
                                        ...
                                        <div class='single-product-wrap'>
                                            <div class='product-image'>
                                                <a href='product?product=".$row['slug']."'>
                                                    <img src='".$image."' width='150px' height='150px' class='thumbnail'>
                                                </a>                                                
                                            </div>
                                            <div class='product_desc'>
                                                <div class='product_desc_info'>
                                                    <div class='product-review'>
                                                        <h5 class='manufacturer'>
                                                            <a href='#'>Sub-Category: ".$row['sub_category_name']."</a>
                                                        </h5>
                                                      </div>
                                                ...
                                                <div class='add-actions'>
                                                    <ul class='add-actions-link'>
                                                        <li class='add-cart active'><a href='product?product=".$row['slug']."'>Quick View</a></li>
