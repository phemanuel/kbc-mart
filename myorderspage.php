    ...
    // variable to store number of rows per page
                        ...
                        // try{
                            //$inc = 4;  
                                    ...
                                    try{
                                        $stmt = $conn->prepare("SELECT * FROM sales WHERE user_id=:user_id  ORDER BY sales_date DESC LIMIT $initial_page, $limit");
...
$getQuery = "SELECT COUNT(*) FROM sales WHERE user_id='".$_SESSION['user'] ."'";     

$result = mysqli_query($conn1, $getQuery);     
...
if($page_number>=2){   
    ...
    echo "<li class='Previous'><a href='myorderspage?page=".($page_number-1)."'>  <strong>Prev</strong> </a></li>";   
...
for ($i=1; $i<=$total_pages; $i++) {   
  ...
  if ($i == $page_number) {   
      ...
      $pageURL .= "<li><a class = 'active' href='myorderspage?page="  
      ...
      $pageURL .= "<li><a href='myorderspage?page=".$i."'>   
...
if($page_number<$total_pages){   
    ...
    echo "<li class='Next'><a href='myorderspage?page=".($page_number+1)."'>  <strong>Next</strong> </a></i></li>";   
