                        ...
                        // try{
                            ...
                            if ($result1->num_rows > 0) {
                                ...
                                $image = (!empty($row['photo'])) ? 'images/'.$row['photo'] : 'images/noimage.jpg';
                                 ...
                                 echo "<div class='row product-layout-list last-child'> 
                                                    ...
                                                    <div class='col-lg-4'>
                                                        <div class='shop-add-action'>
                                                            <ul class='add-actions-link'>
                                                                <li class='add-cart'><a href='product?product=".$row['slug']."'>View Product</a></li>                                  
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>";
...
if($page_number>=2){   
    ...
    echo "<li class='Previous'><a href='categorypage?page=".($page_number-1)."'>  Prev </a></li>";   
...
if($page_number<$total_pages){   
    ...
    echo "<li class='Next'><a href='categorypage?page=".($page_number+1)."'>  Next </a></i></li>";   
