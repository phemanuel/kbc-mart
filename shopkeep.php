                                                    ...
                                                    <div class='col-lg-5 col-md-7'>
                                                        <div class='product_desc'>
                                                            <div class='product_desc_info'>
                                                                ...
                                                                <div class='price-box'>
                                                                    <span class='new-price'>Category: <b> ".$row['category_name']."</b></span>
                                                                </div>
                                                                <div class='price-box'>
                                                    ...
                                                    <div class='col-lg-4'>
                                                        <div class='shop-add-action'>
                                                            <ul class='add-actions-link'>
                                                                    <li class='add-cart active'><a href='product?product=".$row['slug']."' title='quick view' >Quick view</a></li>
...
?>                                            
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo "
                <li><input type='checkbox' name='product-categori'><a href='#''>".$row['brand_name']."</a></li>
