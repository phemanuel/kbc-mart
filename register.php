...
<head>
        ...
        <title>KBC Supermart || Register</title>
      ...
      if(isset($_SESSION['error'])){
        echo "
          <div class='callout callout-danger text-center'>
           <h6> <strong><p>".$_SESSION['error']."</p> </strong></h6>
          </div>
        ";
      ...
      if(isset($_SESSION['success'])){
        echo "
          <div class='callout callout-success text-center'>
            <h6><strong><p>".$_SESSION['success']."</p> </strong></h6>
          </div>
        ";
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
                            <form action="registeracct" method="POST">
                                <div class="login-form">
                                    <h4 class="login-title">Register</h4>
                                    <div class="row">
                                        <div class="col-md-6 col-12 mb-20">
                                            <label>First Name</label>
                                            <input class="mb-0" type="text" name="firstname" placeholder="First Name" value="<?php echo (isset($_SESSION['firstname'])) ? $_SESSION['firstname'] : '' ?>" required>
                                        </div>
                                        <div class="col-md-6 col-12 mb-20">
                                            <label>Last Name</label>
                                            <input class="mb-0" type="text" name="lastname" placeholder="Last Name" value="<?php echo (isset($_SESSION['lastname'])) ? $_SESSION['lastname'] : '' ?>"  required>
                                        </div>
                                        <div class="col-md-12 mb-20">
                                            <label>Email Address*</label>
                                            <input class="mb-0" type="email" name="email" placeholder="Email Address" value="<?php echo (isset($_SESSION['email'])) ? $_SESSION['email'] : '' ?>" required>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-20">
                                            ...
                                            <input class="mb-0" type="password" name="repassword" placeholder="Confirm Password">
                                        </div>
                                        <?php
            
          ?>
                                        <div class="col-12">
                                            <button class="register-button mt-0" name="signup">Register</button>
                                        </div>

                                        <div class="col-md-8">
                                            <div class="check-box d-inline-block ml-0 ml-md-2 mt-10">
                                                <h6><u><strong><a href="login"> Already have an account, Login</a></strong></u></h6>
                                            </div>
                                        </div>
