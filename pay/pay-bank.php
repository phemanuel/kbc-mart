...
<body>
    ...
    <div class="main">
        ...
        <div class="container" style="margin-left: auto; margin-right: auto;">
            ...
            <tr>
              <td width="42%"><span class="style23 style28">Email Address :</span></td>
              <td width="58%"><span class="style23 style28"><?php echo $email_addy ;?></span></td>
            </tr>            
               <tr>
              <td width="42%"><span class="style23 style28">Payee Name :</span></td>
              <td width="58%"><span class="style23 style28"><?php echo $payname;?></span></td>
            </tr>
             
            <tr>
              <td width="42%"><span class="style23 style28">Mobile No :</span></td>
              <td width="58%"><span class="style23 style28"><?php echo $mobileno ;?></span></td>
            </tr>
             <tr>
              <td width="42%"><span class="style23 style28">Payment Option :</span></td>
              <td width="58%"><span class="style23 style28"><?php echo $payment_option ;?></span></td>
            </tr>
             <tr>
              <td width="42%"></td>
              <td width="58%"><span class="style8"></span></td>
            </tr>
            <tr>
              <td colspan="2"><u><span class="style25">Payment Summary</span></u></td>
              </tr>
              <tr>
              <td width="42%"><span class="style23 style26 style28">Transaction Reference :</span></td>
              <td width="58%"><span class="style23 style26 style28"><?php echo $pay_id?></span></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><span class="style23 style26 style28"><img src="images/plus.png"> <?php echo number_format($total_amount,2) ;?></span></td>
                           ...
                           <tr>
              <td colspan="2"><p class="style28 style26 style32"><strong>Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order won’t be shipped until the funds have cleared in our account.</strong></p>
                </td>
              </tr>
                           <tr>
                             <td><span class="style32 style26 style28"><strong><span class="style1">Bank Name </span></strong></span></td>
                             <td><span class="style32 style26 style28"><strong><span class="style1"> GTB</span></strong></span></td>
                           </tr>
                           <tr>
                             <td><span class="style26 style28 style1"><strong>Acct No</strong></span></td>
                             <td><span class="style26 style28 style1">xxxxxxxxxxxxxxx</span></td>
                           </tr>
                           <tr>
                             <td><span class="style1 style28 style26"><strong>Acct Name</strong></span></td>
                             <td><span class="style26 style28 style1"><strong><span class="style1">KBC Supermart</span></strong></span></td>
                           </tr>
                           <tr>
...
paymentForm.addEventListener("submit", payWithPaystack, false);
  function payWithPaystack(){
    ...
    amount: document.getElementById("total_amount").value * 100,
      ...
      ref: 'EASYSHOP'+Math.floor((Math.random() * 1000000000) + 1), // generates a pseudo-unique reference. Please replace with a reference you generated. Or remove the line entirely so our API will generate one for you
