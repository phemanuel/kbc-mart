...
<head>
        ...
        <title>KBC Supermart || Home </title>
                                        ...
                                        <li class="hm-minicart">
                                            ...
                                            <div class="minicart">
                                                <ul class="minicart-product-list">
                                                    ...
                                                    <li class="header">You have <strong><span class="cart_count"></span></strong>  item(s) in cart</li>
              <li>
                ...
                <div class="container">
                    <div class="row">
                                ...
                                <div class="slider-active owl-carousel">
                                    ...
                                    <div class="single-slide align-center-left  animation-style-01 bg-1">
                                        ...
                                        <div class="slider-content">
                                            ...
                                            <h2>Zara -> Men Shoe | Ladies Shoe</h2>
                                            <h3>Starting at <span>=N=33,000.00</span></h3>
                                            <div class="default-btn slide-btn">
                                                <a class="links" href="shop">Shop Now</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single-slide align-center-left animation-style-02 bg-2">
                                        ...
                                        <div class="slider-content">
                                            ...
                                            <h2>Lapel Mic</h2>
                                            <h3>Starting at <span>=N=8,000.00</span></h3>
                                            <div class="default-btn slide-btn">
                                                <a class="links" href="shop">Shop Now</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="single-slide align-center-left animation-style-01 bg-3">
                                        ...
                                        <div class="slider-content">
                                            <h5>Sale Offer <span>5% Off</span> This Week</h5>
                                            <h2>Electric Grater</h2>
                                            <h3>Starting at <span>=N=6,500.00</span></h3>
                                            <div class="default-btn slide-btn">
                                                <a class="links" href="shop">Shop Now</a>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 text-center pt-xs-30">
                            <div class="li-banner">
                                <a href="#">
                                    <img src="images/banner/flashsales.png" alt="">
                            ...
                            <div class="sidebar-categores-box mt-sm-30 mt-xs-30">
                                <div class="sidebar-title">
                                    <h2>Most viewed products today</h2>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="li-product-tab">
                                <ul class="nav li-product-menu">
                                   <li><a class="active" data-toggle="tab" href="#li-new-product"><span>Fashion Accessories</span></a></li>
                                            ...
                                            <div class='product_desc'>
                                                ...
                                                <div class='add-actions'>
                                                    <ul class='add-actions-link'>                                                    
                                                        ...
                                                        <li><a class='links-details' href='wishlistadd?id=".$row['id']."'><i class='fa fa-heart-o'></i></a></li>
                                                        <li><a href='product?product=".$row['slug']."' title='quick view' class='quick-view-btn'><i class='fa fa-eye'></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><br><br>";
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="li-product-tab">
                                <ul class="nav li-product-menu">
                                   <li><a class="active" data-toggle="tab" href="#li-new-product"><span>Gadgets</span></a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="li-product-tab">
                                <ul class="nav li-product-menu">
                                   <li><a class="active" data-toggle="tab" href="#li-new-product"><span>Household Items</span></a></li>
