...
<head>
        ...
        <title>KBC Supermart || <?php echo $cat_slug; ?> </title>
                ...
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            ...
                            <li class="active"><?php echo $cat_slug ; ?></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="content-wraper pt-60 pb-60 pt-sm-30">
                <div class="container">
                    <div class="row">
                        ...
                        // try{
                            //$inc = 4;  
                            $sql = "SELECT id,category_id,category_name,name,description,slug,price,photo,date_view FROM products WHERE category_id='".$cat_id."' "; 
                            $result = $conn->query($sql);

                            $sql1="SELECT * FROM products WHERE category_id='$cat_id' LIMIT $initial_page, $limit";
                                                            ...
                                                            <div class='product_desc_info'>
                                                                <div class='product-review'>
                                                                    <h5 class='manufacturer'>
                                                                        <strong><a href=''>Category: ".$cat_slug."</a></strong>
                                                                    </h5>
...
$getQuery = "SELECT COUNT(*) FROM products WHERE category_id='".$cat_id."'";     
...
if($page_number>=2){   
    ...
    echo "<li class='Previous'><a href='categorypage?page=".($page_number-1)."'>  <strong>Prev</strong> </a></li>";   
...
for ($i=1; $i<=$total_pages; $i++) {   
  ...
  if ($i == $page_number) {   
      ...
      $pageURL .= "<li><a class = 'active' href='categorypage?page="  
      ...
      $pageURL .= "<li><a href='categorypage?page=".$i."'>   
...
if($page_number<$total_pages){   
    ...
    echo "<li class='Next'><a href='categorypage?page=".($page_number+1)."'>  <strong>Next</strong> </a></i></li>";   
...
?>                                            
                                ...
                                <div class="filter-sub-area pt-sm-10 pt-xs-10">
                                    <h5 class="filter-sub-titel">SUB-CATEGORY <?php echo " -> " .$slug;  ?></h5>
                                    <div class="categori-checkbox">
                                        <form action="#">
                                                 <ul>
                                            <?php
    $sql = "SELECT id, cat_name, sub_cat_name,sub_cat_slug FROM subcategory where cat_name='$slug' ";
    $result = $conn->query($sql);
