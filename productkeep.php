...
<head>
        ...
        <title>KBC Supermart || <?php echo $cat['name']; ?> </title>
                                ...
                                <div class="shop-bar-inner">
                                    <div class="product-view-mode">
                                        ...
                                        <ul class="nav shop-item-filter-list" role="tablist">                                           
                                            <li role="presentation"><a aria-selected="true"  data-toggle="tab" role="tab" aria-controls="grid-view" href="#grid-view"><i class="fa fa-th"></i></a></li>
                                                    ...
                                                    <div class="col-lg-5 col-md-7">
                                                        <div class="product_desc">
                                                            <div class="product_desc_info">
                                                                ...
                                                                <h4><a class="product_name" href="#"><?php echo $product['prodname']; ?></a></h4>
                                                                <div class="price-box">
                                                                    <span class="new-price"><b>&#36; <?php echo number_format($product['price'], 2); ?></b></span>
                                                                </div><br>
