...
if($page_number>=2){   
    ...
    echo "<li><a href='categorypage?page=".($page_number-1)."'>  <strong>Prev</strong> </a></li>";   
...
if($page_number<$total_pages){   
    ...
    echo "<li><a href='categorypage?page=".($page_number+1)."'>  <strong>Next</strong> </a></li>";   
